...
<h2>Decrease/Increase A Period's Counter</h2>
<form action="minuscount.php" method="POST">
<input type="text" name="numofchange">
<select name="increaseordecrease"><option>Decrease</option><option>Increase</option></select>
<select name="periodforchange"><option>R1</option><option>R2</option><option>R3</option><option>R4</option><option>R6</option><option>R7</option></select>
<input type="submit" value="Modify Count">
</form>
<h2>Check Hash Validity</h2>
<form action="docheckin.php" method="POST">
<input type="text" name="hash"><input type="submit" value="Check Validity"><br>
<b>Enter any letters in the hash as lower case!</b>
</form>
<br>
<a href="password_protect.php?logout">Log Out and Return to the Main Signup Page</a>
</body>
</html>
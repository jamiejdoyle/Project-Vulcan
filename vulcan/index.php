...
<html lang="en">
  <head>
	...
	function openHome() {
		if (currentpage == "faq") { $("#faq").fadeOut("slow"); setTimeout('$("#form").fadeIn("slow");', 700); setTimeout('$("#mehtitle").fadeIn("slow");', 700); setTimeout('$("#advertising1").fadeIn("slow");', 700); setTimeout('("#advertising2").fadeIn("slow");', 700); $("#faqli").removeClass("active"); }
		else if (currentpage == "contact") { $("#contact").fadeOut("slow"); setTimeout('$("#form").fadeIn("slow");', 700); setTimeout('$("#mehtitle").fadeIn("slow");', 700); setTimeout('$("#advertising1").fadeIn("slow");', 700); setTimeout('("#advertising2").fadeIn("slow");', 700); $("#contactli").removeClass("active"); }
		currentpage = "home";
		$("#homeli").addClass("active");
	}
	function openFAQ() {
		if (currentpage == "home") { $("#form").fadeOut("slow"); $("#mehtitle").fadeOut("slow"); $("#advertising1").fadeOut("slow"); $("#advertising2").fadeOut("slow"); setTimeout('$("#faq").fadeIn("slow");', 700); $("#homeli").removeClass("active"); }
		else if (currentpage == "contact") { $("#contact").fadeOut("slow"); $("#mehtitle").fadeOut("slow"); $("#advertising1").fadeOut("slow"); $("#advertising2").fadeOut("slow"); setTimeout('$("#faq").fadeIn("slow");', 700); $("#contactli").removeClass("active"); }
		currentpage = "faq";
		$("#faqli").addClass("active");
	}
	function openContact() {
		if (currentpage == "home") { $("#form").fadeOut("slow"); $("#mehtitle").fadeOut("slow"); $("#advertising1").fadeOut("slow"); $("#advertising2").fadeOut("slow"); setTimeout('$("#contact").fadeIn("slow");', 700); $("#homeli").removeClass("active"); }
		else if (currentpage == "faq") { $("#faq").fadeOut("slow"); $("#mehtitle").fadeOut("slow"); $("#advertising1").fadeOut("slow"); $("#advertising2").fadeOut("slow"); setTimeout('$("#contact").fadeIn("slow");', 700); $("#faqli").removeClass("active"); }
		currentpage = "contact";
